...
// ==============================================================
#ifndef __Conv_mac_muladd_8bkb__HH__
#define __Conv_mac_muladd_8bkb__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(Conv_mac_muladd_8bkb) {
    ...
    SC_CTOR(Conv_mac_muladd_8bkb):  simcore_mac_0_U ("simcore_mac_0_U") {
