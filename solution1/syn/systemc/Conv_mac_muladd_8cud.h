...
// ==============================================================
#ifndef __Conv_mac_muladd_8cud__HH__
#define __Conv_mac_muladd_8cud__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(Conv_mac_muladd_8cud) {
    ...
    SC_CTOR(Conv_mac_muladd_8cud):  simcore_mac_1_U ("simcore_mac_1_U") {
